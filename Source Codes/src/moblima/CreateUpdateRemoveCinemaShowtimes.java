...
public class CreateUpdateRemoveCinemaShowtimes2 {
...
private static master Master;
	 ...
	 */
	public CreateUpdateRemoveCinemaShowtimes2(master m){
		Master = m;
	}
	        ...
	        do {	System.out.print("\n"
	                ...
	                if (selection == 1) {
						...
						switch(updateSelection)
						{
							...
							{
								System.out.printf("%d) "+Cineplexes_2.get(i).getCineplexName()+"\n",i+1);
							}
							System.out.println("");
